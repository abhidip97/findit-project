...
// Get provider stats
$total_services = $pdo->prepare("
  SELECT COUNT(*) FROM services WHERE provider_id = ?
");
$total_services->execute([$user_id]);
  ...
  <main id="dash-main">
    ...
    <div id="dash-topbar">
      <div>
        ...
        <p id="dash-sub">Manage your provider account details.</p>
      </div>
    </div>
    ...
    <div id="profile-layout">
      ...
      <div id="profile-left">
        <div id="profile-card">
          <div id="profile-avatar" style="background: linear-gradient(135deg,#F97316,#fb923c);">
          ...
          <span class="role-badge role-provider">Service Provider</span>

          <div id="profile-stats">
            <div class="p-stat">
              <span class="p-stat-num"><?= $total_services ?></span>
              <span class="p-stat-label">Services</span>
            </div>
            <div class="p-stat">
              <span class="p-stat-num"><?= $total_bookings ?></span>
              <span class="p-stat-label">Bookings</span>
            </div>
            <div class="p-stat">
              <span class="p-stat-num"><?= $avg_rating ?>★</span>
              <span class="p-stat-label">Rating</span>
            </div>
          </div>
      ...
      <div id="profile-right">
        ...
        <div class="profile-panel">
          ...
          <form method="POST" action="profile.php">
            ...
            <div class="form-group">
              <label class="form-label">Address / Service Area</label>
